...
//function for changing color on mountains
const changeColorOn= function() {

  const mountains = document.querySelectorAll('.mountain');
  mountains.forEach(function(mountainElem){
    mountainElem.setAttribute('animation', {property:'material.color', from:'#91433f', to:'#3b1f4f', loop:true,dur:20000, easing:'easeInOutQuad', enabled:false});
  });
}

//function for changing color off mountains
const changeColorOff= function() {

  const mountains = document.querySelectorAll('.mountain');
  mountains.forEach(function(mountainElem){
     mountainElem.setAttribute('animation', {property:'material.color', from:'#91433f', to:'#3b1f4f', loop:true,dur:20000, easing:'easeInOutQuad', enabled:true});
  });
}